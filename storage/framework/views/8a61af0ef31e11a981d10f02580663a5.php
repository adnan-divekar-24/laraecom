					...
					<form action="<?php echo e(route('admin.authenticate')); ?>" method="post">
						<?php echo csrf_field(); ?>
				  		<div class="input-group mb-3">
							<input type="email" name="email" value="<?php echo e(old('email')); ?>" id="email" class="form-control <?php $__errorArgs = ['email'];
...
</html><?php /**PATH C:\xampp\htdocs\laraecom\resources\views/admin/login.blade.php ENDPATH**/ ?>